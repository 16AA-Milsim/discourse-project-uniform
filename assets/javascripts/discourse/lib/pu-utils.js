...
export const puPaths = {
    ...
    rank: (file) => getURL(`${BASE}/ranks/${file}`),
    ...
    csaRibbon: (file) => getURL(`${BASE}/csa/${file}`),
    csaTooltip: (file) => getURL(`${BASE}/csa_tooltips/${file}`),
    qual: (file) => getURL(`${BASE}/qualifications/${file}`),
